 ...
 * <p><em>Original author: Robert Harder, rharder@usa.net</em></p> <p>2007-09-12
 * Nathan Blomquist -- Linux (KDE/Gnome) support added.</p>
 *
...
public class FileDrop {
     ...
     * all components contained within <var>c</var> if <var>c</var> is a {@link java.awt.Container}.
     *
     ...
     * {@link FileDropListener#filesDropped filesDropped(...)} method in your {@link FileDropListener}
    ...
    public static class Event extends java.util.EventObject {
         ...
         *
         * @param files The array of files that were dropped @source The event
         * source
         * @since 1.1
         */
     ...
     * dropping in your Java programs! When you need to create a {@link java.awt.datatransfer.Transferable}
     ...
     * like when you're moving data out of a list, say, you can use the {@link TransferableObject.Fetcher}
     ...
     * flavor is accessible via the static
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable {
        ...
        /**
         * Creates a new {@link TransferableObject} that will return the object
         * that is returned by <var>fetcher</var>. Along with the {@link #DATA_FLAVOR}
         ...
         * associated with the encapsulated object or <tt>null</tt> if the {@link Fetcher}
         ...
         * the {@link Fetcher} constructor was used, then this is when the {@link Fetcher#getObject getObject()}
         * method will be called. If the requested data flavor is not supported,
         * then the
         ...
         * flavors. Flavors are supported using the
         ...
         * it). When the {@link #getTransferData getTransferData(...)} method is
         * called on the {@link TransferableObject}, the {@link Fetcher}'s
